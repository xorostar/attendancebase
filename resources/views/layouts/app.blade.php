...
<body>
                    ...
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre >
                            <span data-toggle="tooltip" data-placement="bottom" title="Account">
                                <div class="rounded-circle d-inline-block" style="width:32px; height:32px; background-image:url({{ asset("images/avatar.png") }}); background-position: center; background-size: cover;
    ...
    <div id="side-nav" class="side-nav shadow-lg">
        ...
        <a class="font-weight-normal active" href="{{ route("pages.home") }}">
        ...
        <a class="font-weight-normal" href="{{ route("pages.archive") }}">
        ...
        {{-- <a class="font-weight-normal" href="#">
